...
from Global.summa.syntactic_unit import SyntacticUnit
...
AB_SENIOR = re.compile(r"([A-ZА-Я\Ә\І\Ң\Ғ\Ү\Ұ\Қ\Ө\Һ][a-zа-я\ә\і\ң\ғ\ү\ұ\қ\ө\һ]{1,2}\.)\s(\w)")
AB_ACRONYM = re.compile(r"(\.[A-Za-zА-Яа-я\ә\і\ң\ғ\ү\ұ\қ\ө\һ\Ә\І\Ң\Ғ\Ү\Ұ\Қ\Ө\Һ]\.)\s(\w)")
AB_ACRONYM_LETTERS = re.compile(r"([a-zA-Z\ә\і\ң\ғ\ү\ұ\қ\ө\һ\Ә\І\Ң\Ғ\Ү\Ұ\Қ\Ө\Һ])\.([a-zA-Z\ә\і\ң\ғ\ү\ұ\қ\ө\һ\Ә\І\Ң\Ғ\Ү\Ұ\Қ\Ө\Һ])\.")
UNDO_AB_SENIOR = re.compile(r"([A-ZА-Я\Ә\І\Ң\Ғ\Ү\Ұ\Қ\Ө\Һ][a-zа-я\ә\і\ң\ғ\ү\ұ\қ\ө\һ]{1,2}\.)" + SEPARATOR + "(\w)")
UNDO_AB_ACRONYM = re.compile(r"(\.[A-Za-zА-Яа-я\ә\і\ң\ғ\ү\ұ\қ\ө\һ\Ә\І\Ң\Ғ\Ү\Ұ\Қ\Ө\Һ]\.)" + SEPARATOR + "(\w)")
